...
<body>
    <header>
        ...
        <div class="nav--mobile">
            ...
            <ul class="nav--infomation__mobile">
                ...
                <li class="items"><a href="#0">Hệ thông 128 siêu thị</a></li>
                <li class="items"><a href="./recruitment.html">Tuyển dụng</a></li>
                <li class="items"><a href="./watched.html">Tra cứu</a></li>
                <li class="items"><a href="../html/login.html">Đăng Nhâp</a></li>
    ...
    <div class="container--cart">
        <h1>Giỏ Hàng</h1>
        <div class="cart--product" data-price="20000000">
            <div class="cart--img">
                <img src="../img/home/iphone13-gold.jpg" alt="">
            </div>
            ...
            <select class="choose">
                ...
                <option value="5G">10GB</option>
                <option value="5G">150GB</option>
            </select>
            <select class="choose">
            ...
            <div class="quantity">
                <button class="btn--cart btn--cart-decrease">-</button>
                <button class="btn--cart__number">1</button>
                <button class="btn--cart btn--cart-increase">+</button>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="checkoutForm">
                        ...
                        <div class="mb-3">
                            <label for="customerEmail" class="form-label">Gmail</label>
                            <input type="email" class="form-control" id="customerEmail" required>
                        </div>
                        <div class="mb-3">
                            <label for="paymentMethod" class="form-label">Loại hình thanh toán</label>
                        ...
                        <a href="#0" class="btn btn-primary">Xác nhận</a>
                    </form>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    ...
                    <ul class="page--suport">
                        ...
                        <li class="item"><a href="./guaranteed.html">Tra cứu bảo hành</a></li>
                    </ul>
                </div>
                <!-- end col -->
                <div class="col-12 col-sm-6 col-md-3">
